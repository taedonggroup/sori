  ...
  return (
    <div className="space-y-6 animate-fadeInUp">
      ...
      <div className="flex items-center justify-between">
        ...
        <Badge variant="outline" className="border-[#F8F32B] text-[#F8F32B] rounded-full text-[10px] tracking-wider">
          {result.preset_applied}
        </Badge>
      </div>

      {/* Full Mix 오디오 */}
      <Card className="bg-zinc-950 border-zinc-800 rounded-2xl py-0">
